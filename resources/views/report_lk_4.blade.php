                    ...
                    <div>
                            ...
                            <table class="table-profile">
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td> {{ isset($userProfile['extra_fields']['jabatan_saat_ini']['value']) > 0 ? $userProfile['extra_fields']['jabatan_saat_ini']['value'] : '-' }}</td>
                                </tr>
                                <tr>
                                    <td>Prospek Jabatan</td>
                                    <td>:</td>
                                    <td> {{ isset($userProfile['extra_fields']['prospek_jabatan']['value']) >0 ? $userProfile['extra_fields']['prospek_jabatan']['value'] : '-' }}</td>
                                </tr>
                            </table>
                        </div>
                <div>
